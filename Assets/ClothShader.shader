Shader "Custom/ClothShader"
{
	Properties
	{
		...
		_RampThreshold("Lambert Threshold",Range(0,1))=0
		_RampSmooth("Lambert Smooth",Range(0,1))=0.1
        ...
        _FresnelIntensity("FresnelIntensity", Range(-1,1))=0.1
        _FresnelThreshold("FresnelThreshold", Range(0, 1))=0.5
        _FresnelSmooth("FresnelSmooth", Range(0,1))=0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
                ...
                //Lambert
                float4 SrcAlbedo=tex2D(_MainTex, i.uv)*_Color;
                ...
                float4 finalColor=LambertColor+SpecularColor;
